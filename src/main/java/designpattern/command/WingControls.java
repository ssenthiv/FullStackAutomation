...
public class WingControls implements CommandControler{
	...
	public void execute(String command) {
		...
		default:
			System.out.println("Sorry i did not understand the wing operation command");
