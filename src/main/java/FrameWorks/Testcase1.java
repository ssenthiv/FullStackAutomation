...
public class Testcase1 extends ModuleBase{
...
public Object[][] TestDataToRun() {
	...
	return moudle1Excel.retrieveTestData("Method1");

}

@Test(dataProvider = "TestDataToRunTest")
public void Method1(String FirstName, String LastName, String Email, String MobileNo,
