...
public class SuiteModule1Page extends Base {
	String methodName;
	String TestCaseName;
	static {
		 Add_Log.info("\tExecuting - Static block -"+ SuiteModule1Page.class.getName());

	 }
	
	public SuiteModule1Page(WebDriver driver, String testCase ){
		this.TestCaseName=testCase;
		this.driver=driver;
		methodName=Thread.currentThread().getStackTrace()[1].getMethodName();
		Add_Log.info("\tExecuting SuiteModule1Page constructor- "+ this.getClass().getSimpleName()+"."+methodName);
...
*/
	...
	public void sendKeysToFirstName(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'FirstName' : "+ element);
	}
	...
	public void sendKeysToLastName(String element){
			...
			Add_Log.info(TestCaseName + ":- Entered  'LastName' : "+ element);
		}
	...
	public void sendKeysToEmail(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'Email' : "+ element);
	}
	...
	public void sendKeysToMobileNo(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'MobileNo' : "+ element);
	}
	...
	public void sendKeysToAddress(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'Address' : "+ element);
	}
	...
	public void sendKeysToSuburb(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'Suburb' : "+ element);
	}
	...
	Add_Log.info(TestCaseName + ":- Entered  'State' : "+ element);
	}
	...
	public void sendKeysToPostCode(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'Post Code' : "+ element);
	...
	public void sendKeysToDob(String element){
		...
		Add_Log.info(TestCaseName + ":- Entered  'Date of Birth' : "+ element);
	...
	if ((element.equals("Y")) && (!TestingForm_TermsAndCondition.isSelected())) {
		...
		Add_Log.info(TestCaseName + ":- Clicked on  'Terms and Condition' : "+ element);
	}
	}
	...
	if (element.equals("Y")) {
		...
		Add_Log.info(TestCaseName + ":- Clicked on  'Submit Button' : "+ element);
	}
	}
	...
	public void verifyTestingFormSubmission() throws InterruptedException {
		try {
			...
			if (!TestingForm_SubmitButton.isDisplayed()){
				reportFailures("SubmtForm" + ":- Testing Form is unexpectedly submitted");
			}
	...
	public void verifyTestingFormConfirmation(String ExpectedResult) throws InterruptedException {
		try {
			...
			if (actualMsg.equalsIgnoreCase(ExpectedResult)) {
				...
				// This function is to file captured failures in the reports.
				reportFailures("SubmtForm" + ":- Testing Form confirmation Message actual: '" + actualMsg
