...
public class Read_XLS {
	...
	public String retrieveToRunFlag(String wsName, String colName, String rowName) {
		System.out.println("\t\t\t\t\tExecuting - "+  this.getClass().getSimpleName()+"."+Thread.currentThread().getStackTrace()[1].getMethodName());
